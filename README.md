...
An automated 60 FPS retro stickman fighting simulation and headless video generation pipeline designed for **YouTube**, **Facebook**, and widescreen video platforms in full **16:9 Landscape**.

---

## ⚡ Core Features

- **16:9 Full HD Landscape Canvas**: Native 1920x1080 widescreen landscape video format for desktop and full-width video players.
...
- **Headless Chromium Recorder**: Puppeteer launches headless browser, records canvas + synthesized audio into high-bitrate 16:9 Full HD MP4.
...
To run a headless simulation and export a 1920x1080 16:9 Landscape Full HD MP4 video to `output/`:
...
The workflow in `.github/workflows/generate_reel.yml` automatically triggers **2x daily** (at `08:00 UTC` and `20:00 UTC`), simulates a 3-round tournament, converts the footage to **16:9 Landscape Full HD MP4 (1920x1080)** with Halal Duff audio, and sends it directly to your Telegram chat.
...
2. Select **Automated Stickman 16:9 Landscape Video Pipeline** on the left menu.
...
5. Click the green **Run workflow** button. Within ~2-3 minutes, the 16:9 landscape Full HD MP4 match will be delivered straight to your Telegram!

### 4. Pushing to GitHub
```bash
git init
git add .
git commit -m "feat: 16:9 landscape Full HD MP4 pipeline with 2x daily telegram dispatch"
git branch -M main
